...
use rls::analysis;
pub use rls::config::Config;
pub use rls::server::{self as ls_server, ServerMessage, Request, Method};
pub use rls::vfs;
pub use rls::lsp_data;
use rls::lsp_data::*;

pub const TEST_TIMEOUT_IN_SEC: u64 = 240;

pub fn make_init_msg(id: usize, root_path: Option<String>) -> ServerMessage {
     make_init_msg_with_opts(id, root_path, None)
}

pub fn make_init_msg_with_opts(id: usize, root_path: Option<String>, initialization_options: Option<InitializationOptions>) -> ServerMessage {
...
pub fn make_request_msg(id: usize, method: Method) -> ServerMessage {
